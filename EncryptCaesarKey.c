...
DecryptCaesar(stament[100],number);
...
if (message[i]>65 && message[i]<90)
    decrypt = 1; // if the ASCII value is between the captials decrypt = 1 
else
    decrypt = 0; // otherwise decrypt= 0 e.g whitespace or a symbol 
switch(decrypt){
    case 1:
